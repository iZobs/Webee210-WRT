...
*/
#ifndef _HDMI_S5P_TV_H_
#define _HDMI_S5P_TV_H_
...
/* #define S5P_GRP_DEBUG */
/* #define S5P_STDA_TVOUTIF_DEBUG */
/* #define S5P_VLAYER_DEBUG */
/* #define S5P_TV_BASE_DEBUG */
/* #define S5P_V4L2_DEBUG */
...
extern const struct v4l2_ioctl_ops g_s5p_tv_v4l2_v_ops;
extern const struct v4l2_ioctl_ops g_s5p_tv_v4l2_vo_ops;
extern const struct v4l2_ioctl_ops g_s5p_tv_v4l2_ops;
extern const struct v4l2_ioctl_ops g_s5p_tv_v4l2_vid_ops;

extern struct s5p_tv_status g_s5ptv_status;
extern struct s5p_tv_vo g_s5ptv_overlay[2];
...
bool s5p_vlayer_api_proc(unsigned long arg, u32 cmd);
...
/* hdmi_xxx.c */
int __init s5p_hdmi_probe(struct platform_device *pdev,  u32 res_num, u32 res_num2);
...
void                 s5p_hdmi_audio_set_repetition_time(enum s5p_tv_audio_codec_type audio_codec,
...
enum s5p_tv_hdmi_err s5p_hdmi_init_spd_infoframe(enum s5p_hdmi_transmit trans_type,
						 u8 *spd_header, u8 *spd_data);
void                 s5p_hdmi_init_hpd_onoff(bool on_off);
enum s5p_tv_hdmi_err s5p_hdmi_audio_init(enum s5p_tv_audio_codec_type audio_codec,
					 u32 sample_rate, u32 bits, u32 frame_size_code);
enum s5p_tv_hdmi_err s5p_hdmi_video_init_display_mode(enum s5p_tv_disp_mode disp_mode,
...
enum s5p_tv_hdmi_err s5p_hdmi_video_init_csc(enum s5p_tv_hdmi_csc_type csc_type);
enum s5p_tv_hdmi_err s5p_hdmi_video_init_avi_infoframe(enum s5p_hdmi_transmit trans_type,
						       u8 check_sum, u8 *pavi_data);
enum s5p_tv_hdmi_err s5p_hdmi_video_init_mpg_infoframe(enum s5p_hdmi_transmit trans_type,
						       u8 check_sum, u8 *pmpg_data);
void                 s5p_hdmi_video_init_tg_cmd(bool t_correction_en,
...
enum s5p_tv_vp_err s5p_vp_set_top_field_address(u32 top_y_addr, u32 top_c_addr);
enum s5p_tv_vp_err s5p_vp_set_bottom_field_address(u32 bottom_y_addr, u32 bottom_c_addr);
enum s5p_tv_vp_err s5p_vp_set_img_size(u32 img_width, u32 img_height);
void               s5p_vp_set_src_position(u32 src_off_x,
					   u32 src_x_fract_step, u32 src_off_y);
...
void               s5p_vp_set_src_dest_size_with_default_poly_filter_coef(u32 src_width, u32 src_height,
									  u32 dst_width, u32 dst_height,
									  bool ipc_2d);
enum s5p_tv_vp_err s5p_vp_set_brightness_contrast_control(enum s5p_vp_line_eq eq_num,	u32 intc, u32 slope);
...
enum s5p_tv_vp_err s5p_vp_init_layer(u32 top_y_addr, u32 top_c_addr, u32 bottom_y_addr,
...
enum s5p_tv_vp_err s5p_vp_init_layer_def_poly_filter_coef(u32 top_y_addr,
...
enum s5p_tv_vp_err s5p_vp_init_poly_filter_coef(enum s5p_vp_poly_coeff poly_coeff,
						signed char ch0, signed char ch1,
						signed char ch2, signed char ch3);
void               s5p_vp_init_bypass_post_process(bool bypass);
enum s5p_tv_vp_err s5p_vp_init_csc_coef(enum s5p_vp_csc_coeff csc_coeff, u32 coeff);
void               s5p_vp_init_saturation(u32 sat);
void               s5p_vp_init_sharpness(u32 th_h_noise, enum s5p_vp_sharpness_control sharpness);
enum s5p_tv_vp_err s5p_vp_init_brightness_contrast_control(enum s5p_vp_line_eq eq_num,
							   u32 intc, u32 slope);
...
enum s5p_tv_vmx_err s5p_vm_set_win_blend(enum s5p_tv_vmx_layer layer, bool enable);
enum s5p_tv_vmx_err s5p_vm_set_layer_alpha(enum s5p_tv_vmx_layer layer, u32 alpha);
enum s5p_tv_vmx_err s5p_vm_set_layer_show(enum s5p_tv_vmx_layer layer, bool show);
enum s5p_tv_vmx_err s5p_vm_set_layer_priority(enum s5p_tv_vmx_layer layer, u32 priority);
enum s5p_tv_vmx_err s5p_vm_set_grp_base_address(enum s5p_tv_vmx_layer layer, u32 baseaddr);
...
enum s5p_tv_vmx_err s5p_vm_init_status_reg(enum s5p_vmx_burst_mode burst, enum s5p_endian_type endian);
enum s5p_tv_vmx_err s5p_vm_init_display_mode(enum s5p_tv_disp_mode mode, enum s5p_tv_o_mode output_mode);
...
void                s5p_vm_set_ctrl(enum s5p_tv_vmx_layer layer, bool premul,
...
enum s5p_tv_vmx_err s5p_vm_init_bg_color(enum s5p_tv_vmx_bg_color_num color_num,
					 u32 color_y, u32 color_cb, u32 color_cr);
...
enum s5p_tv_vmx_err s5p_vm_get_layer_info(enum s5p_tv_vmx_layer layer, bool *show, u32 *priority);
void                s5p_vm_start(void);
void                s5p_vm_stop(void);
enum s5p_tv_vmx_err s5p_vm_set_underflow_interrupt_enable(enum s5p_tv_vmx_layer layer, bool en);
...
enum s5p_tv_sd_err s5p_sdout_init_video_scale_cfg(enum s5p_sd_level component_level,
						  enum s5p_sd_vsync_ratio component_ratio,
						  enum s5p_sd_level composite_level,
						  enum s5p_sd_vsync_ratio composite_ratio);
enum s5p_tv_sd_err s5p_sdout_init_sync_signal_pin(enum s5p_sd_sync_sig_pin pin);
...
void               s5p_sdout_init_svideo_color_compensation(u32 y_top, u32 y_bottom, u32 y_c_cylinder);
void               s5p_sdout_init_component_porch(u32 back_525, u32 front_525, u32 back_625, u32 front_625);
enum s5p_tv_sd_err s5p_sdout_init_vesa_rgb_sync(enum s5p_sd_vesa_rgb_sync_type sync_type,
...
enum s5p_tv_sd_err s5p_sdout_init_ch_xtalk_cancel_coef(enum s5p_sd_channel_sel channel,
						       u32 coeff2, u32 coeff1);
void               s5p_sdout_init_closed_caption(u32 display_cc, u32 non_display_cc);
enum s5p_tv_sd_err s5p_sdout_init_wss525_data(enum s5p_sd_525_copy_permit copy_permit,
					      enum s5p_sd_525_mv_psp mv_psp,
					      enum s5p_sd_525_copy_info copy_info,
					      bool analog_on,
					      enum s5p_sd_525_aspect_ratio display_ratio);
...
enum s5p_tv_sd_err s5p_sdout_init_cgmsa625_data(bool surround_sound,
					...
					enum s5p_sd_625_aspect_ratio display_ratio);
enum s5p_tv_sd_err s5p_sdout_init_display_mode(enum s5p_tv_disp_mode disp_mode,
					       enum s5p_tv_o_mode out_mode,
					       enum s5p_sd_order order);
...
void s5p_tv_power_init_dac_onoff(bool on);
